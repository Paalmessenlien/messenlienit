...
<div id="kwick">
	<ul class="kwicks" style="background: url( /{$valid_nodes[0].data_map.hoyre.content.original.full_path}) no-repeat scroll top right">
		<li>
		<a id="kwick_left" class="kwick" style="background: url( /{$valid_nodes[0].data_map.venstre.content.original.full_path}) no-repeat scroll top left;" href="{$valid_nodes[0].data_map.venstre_url.content}"><span>Left</span></a></li>
		<li>
		<a id="kwick_middle" class="kwick" style="background: url( /{$valid_nodes[0].data_map.midt.content.original.full_path}) no-repeat scroll top left" href="{$valid_nodes[0].data_map.midt_url.content}"><span>Middle</span></a></li>
		<li>
		<a id="kwick_right" class="kwick" style="background: url( /{$valid_nodes[0].data_map.hoyre.content.original.full_path}) no-repeat scroll top right" href="{$valid_nodes[0].data_map.hoyre_url.content}"><span>Right</span></a></li>
	</ul>
</div>
