    ...
    *}
    ...
    {if $node.object.content_class.is_container}
        ...
        {elseif and( is_set( $node.data_map.show_children ), $node.data_map.show_children.data_int )}
            ...
            {/if}
        {/if}
<a href={concat("/survey/result/", $node.contentobject_id, '/', $node.data_map.survey.contentclass_attribute.id, '/', $node.data_map.survey.language_code)|ezurl()}>Resultater</a>
