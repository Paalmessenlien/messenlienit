...
<div class="content-view-full">
    <div class="class-forum-topic">
        ...
        <div class="content-navigator">
          ...
          <table class="list forum" cellspacing="0">
            ...
            <tr class="bglight">
               ...
               <td class="message">
                   <p class="date">Skrevet den: {$node.object.published|l10n(datetime)}</p>
                   <p>
        ...
        <form method="post" action={"content/action/"|ezurl}>
            <input class="button forum-new-reply" type="submit" name="NewButton" value="Ny kommentar" />
            <input type="hidden" name="ContentNodeID" value="{$node.node_id}" />
            <input type="hidden" name="ContentObjectID" value="{$node.contentobject_id}" />
            <input class="button forum-keep-me-updated" type="submit" name="ActionAddToNotification" value="Hold meg oppdatert om dette innlegget" />
