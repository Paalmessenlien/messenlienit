...
<ul>
    <li>{"A valid username and password is required to login."|i18n("design/ezwebin/user/login")} <a href={'/user/register'|ezurl}>Dette kan du få ved å registrere deg her</a></li>
