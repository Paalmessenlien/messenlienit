<div class="toppmenu">
    ...
    <ul>
    <li id="hjem"><a href={"/"|ezurl} title="{ezini('SiteSettings','SiteName')}">Hjem</a></li>
    ...
    {undef $root_node $top_menu_items $item_class $top_menu_items_count $current_node_in_path}
     <li id="rss">
    	<a href="{$pagedesign.data_map.rss_feed.data_text}"><img src={'RSS.png'|ezimage()} align="middle" width="14" height="14" alt="RSS" />RSS</a>
	</li>
    </ul>
