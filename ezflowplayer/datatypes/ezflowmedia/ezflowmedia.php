...
/*!
  \class ezflowMedia flowmedia.php
  \ingroup eZDatatype
  \brief The class ezflowMedia handles registered media files
...
class ezflowMedia extends eZPersistentObject
{
    ...
    static function definition()
    {
        return array( "fields" => array( "contentobject_attribute_id" => array( 'name' => "ContentObjectAttributeID",
										...
										'movie' => array( 'name' => 'Movie',
                                                         ...
                                                         'default' => '',
                                                         'required' => true ),
										'streaming' => array( 'name' => 'Streaming',
                                                         'datatype' => 'string',
                                                         'default' => '',
                                                         'required' => true ),
    ...
    static function fetch( $id, $version, $asObject = true )
    {
        if( $version == null )
        {
            return eZPersistentObject::fetchObjectList( ezflowMedia::definition(),
                                                        null,
        ...
        {
            return eZPersistentObject::fetchObject( ezflowMedia::definition(),
                                                    null,
                                                    array( "contentobject_attribute_id" => $id,
                                                           "version" => $version ),
                                                    $asObject );
    ...
    static function removeByID( $id, $version )
    {
        if( $version == null )
        {
            eZPersistentObject::removeObject( ezflowMedia::definition(),
                                              array( "contentobject_attribute_id" => $id ) );
        }
        else
        {
